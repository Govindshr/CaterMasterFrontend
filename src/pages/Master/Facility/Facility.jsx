...
export default function Facilities() {
  ...
  const addFacility = async () => {
    ...
    if (!type) {
      setErrorType("Facility type is required");
      valid = false;
    } else {
      setErrorType("");
    }
    ...
    if (isPaid && (!price || parseFloat(price) <= 0)) {
      setErrorPrice("Price is required and must be greater than 0");
      valid = false;
    } else {
      setErrorPrice("");
    }
            ...
            <Dialog open={isModalOpen} onOpenChange={setIsModalOpen}>
              <DialogTrigger asChild>
                ...
                <div className="space-y-3">
                  ...
                  />
                  {errorEn && <p className="text-red-500 text-xs">{errorEn}</p>}
                  ...
                  <Input
                    ...
                    className="rounded-lg border-gray-300"
                  />
                  {errorHi && <p className="text-red-500 text-xs">{errorHi}</p>}
                </div>
                ...
                {isPaid && (
                  <>
                    ...
                    <Input
                      ...
                      className="rounded-lg border-gray-300"
                    />
                    {errorPrice && <p className="text-red-500 text-xs">{errorPrice}</p>}
                  </>
                )}
